...
class TextRNN(object):
    def __init__(self, embedding_size, hidden_layers, hidden_units, number_classes, learning_rate,
                 vocab_size, iterator):
        self.hidden_units = hidden_units
        self.keep_prob = tf.placeholder(tf.float32, name='keep_prob')
        self.input_y, self.input_x = iterator.get_next()
        self.input_y = tf.one_hot(self.input_y, depth=2)
